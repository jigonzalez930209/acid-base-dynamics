  ...
  es: {
    translation: {
      ...
      advanced: {
        ...
        complexation: {
          title: "Equilibrios de complejación · K\u1d53, K\u1d53′, K\u1d53″",
          description: "Kf es la constante termodinámica de formación del complejo M–ligando. Kf′ es la constante condicional que corrige las reacciones laterales del ligando (protonación del EDTA según el pH). Kf″ es la constante doblemente condicional que también incluye la hidrólisis del metal. Umbral de titulabilidad: log Kf″ ≥ 8.",
          tabEdta: "EDTA (Kf, Kf′, Kf″)",
          tabStepwise: "Escalonados (NH₃)",
          pHLabel: "pH de trabajo",
          metal: "Metal",
          minPH: "pH mín. titulación",
          sparklineLabel: "αY⁴⁻ vs pH — fracción libre de EDTA",
          stepwiseDesc: "Constantes escalonadas Kn y globales βn para complejos metálicos con amoniaco. βn = K₁·K₂·…·Kn.",
        },
      },
    },
  },
  en: {
    translation: {
      ...
      advanced: {
        ...
        complexation: {
          title: "Complexation equilibria · K\u1d53, K\u1d53′, K\u1d53″",
          description: "Kf is the thermodynamic formation constant for the M–ligand complex. Kf′ is the conditional constant correcting for ligand side reactions (EDTA protonation at the working pH). Kf″ is the doubly-conditional constant additionally accounting for metal hydrolysis. Titration threshold: log Kf″ ≥ 8.",
          tabEdta: "EDTA (Kf, Kf′, Kf″)",
          tabStepwise: "Stepwise (NH₃)",
          pHLabel: "Working pH",
          metal: "Metal",
          minPH: "Min. titration pH",
          sparklineLabel: "αY⁴⁻ vs pH — free EDTA fraction",
          stepwiseDesc: "Stepwise constants Kn and overall constants βn for metal–ammonia complexes. βn = K₁·K₂·…·Kn.",
        },
      },
    },
  },
