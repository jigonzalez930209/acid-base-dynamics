    ...
    translation: {
      ...
      advanced: {
        ...
        precipitation: {
          ...
          concentration: "Concentración inicial",
          pHWork: "pH de trabajo",
        ...
        complexExplorer: {
          title: "Explorador de complejación: un ligando, varios metales",
          description: "Seleccioná un ligando y hasta 3 metales para comparar sus equilibrios de complejación, constantes escalonadas Kn, constantes globales βn, constantes condicionales Kf′ y Kf″, distribuciones de especies y mapas de predominio.",
          ligand: "Ligando",
          numMetals: "Metales a comparar",
          metal: "Metal",
          pHWork: "pH de trabajo",
          noData: "Sin datos para esta combinación",
          tabOverview: "Resumen",
          tabEq: "Ecuaciones",
          tabPredom: "Predominio",
        },
      },
      pro: {
        dashboard: "Dashboard",
        ...
        redox: "Redox",
        labTools: "Laboratorio",
        visualization: "Visualización",
        education: "Educación",
        settings: "Configuración",
        speciation: "Especiación",
        titration: "Titulación",
        buffer: "Capacidad buffer",
        predominance: "Predominancia",
        sensitivity: "Sensibilidad",
        alphaFractions: "Fracciones α",
        conditionalK: "K condicional",
        explorer: "Explorador",
        solubility: "Solubilidad vs pH",
        selectivePrecip: "Precipitación selectiva",
        nernst: "Ecuación de Nernst",
        pourbaix: "Diagrama Pourbaix",
        galvanic: "Celda galvánica",
        solutions: "Preparar soluciones",
        dilutions: "Diluciones",
        titrationPlan: "Planificar titulación",
        ...
        spontaneous: "Reacción espontánea",
        nonSpontaneous: "Reacción no espontánea",
  ...
  en: {
    translation: {
      ...
      advanced: {
        ...
        complexExplorer: {
          title: "Complexation explorer: one ligand, multiple metals",
          description: "Select a ligand and up to 3 metals to compare their complexation equilibria, stepwise constants Kn, overall constants βn, conditional constants Kf′ and Kf″, species distributions, and predominance maps.",
          ligand: "Ligand",
          numMetals: "Metals to compare",
          metal: "Metal",
          pHWork: "Working pH",
          noData: "No data for this combination",
          tabOverview: "Overview",
          tabEq: "Equations",
          tabPredom: "Predominance",
        },
      },
      pro: {
        dashboard: "Dashboard",
        ...
        alphaFractions: "α Fractions",
        conditionalK: "Conditional K",
        explorer: "Explorer",
        solubility: "Solubility vs pH",
        selectivePrecip: "Selective precipitation",
        nernst: "Nernst Equation",
        pourbaix: "Pourbaix Diagram",
        galvanic: "Galvanic Cell",
        solutions: "Prepare Solutions",
        dilutions: "Dilutions",
        titrationPlan: "Plan Titration",
        ...
        spontaneous: "Spontaneous reaction",
        nonSpontaneous: "Non-spontaneous reaction",
